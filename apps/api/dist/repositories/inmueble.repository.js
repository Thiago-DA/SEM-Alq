...
exports.inmuebleRepository = exports.InmuebleRepository = void 0;
class InmuebleRepository {
    nextId = 10; // Contador secuencial para autogeneración de ID
    inmuebles = [
        {
            id: 1,
            tipo: 1, // Departamento
    ...
    async findByLocadorId(locadorId) {
...
exports.inmuebleRepository = new InmuebleRepository();
